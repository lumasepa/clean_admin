...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text=b'A foreign_key field', to='test_app.ForeingModel'),
        ),
        migrations.AddField(
            model_name='allfieldsmodel',
            name='many_to_many_field',
            field=models.ManyToManyField(help_text=b'A many to many field', to='test_app.ManyToManyModel'),
        ),
        migrations.AddField(
            model_name='allfieldsmodel',
            name='one_to_one_field',
            field=models.OneToOneField(to='test_app.OneToOneModel', help_text=b'A one to one field'),
        ),
    ]
